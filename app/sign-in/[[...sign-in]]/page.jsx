        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <p className="mt-4 leading-relaxed text-white/90">
              Sign in to your shareKaro account and pick up right where you left
              off. Access your shared files, collaborate with others, and enjoy
          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500">
                Sign in to your shareKaro account and pick up right where you
                left off. Access your shared files, collaborate with others, and
                enjoy a seamless sharing experience.
              </p>
            </div>
            <SignIn />;
          </div>
