        ...
        <header className="bg-[#395886]/0 py-1 border shadow-primary/10 shadow-md">
            <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 relative">
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className={`fixed overflow-hidden right-[-100vw] z-40 trans bg-sidebar_color w-[18rem] h-[150lvh] py-16  gap-5 top-[0] md:hidden ${toggle ? 'right-[0] ' : ''}`} ref={sidebarRef} >
